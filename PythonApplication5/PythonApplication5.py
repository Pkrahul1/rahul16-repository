...
print(list(itertools.chain(product(l1,l2),product(l2,l1))))#product(l1,l2) is object but iterable.
...
list3=[list1,list2]#list2 cab be tuple or any other iterable as well.
print(list(itertools.chain.from_iterable(list3)))#same as line number 41
list3=[[1,2,3],[4,5,6]]
print(list(itertools.chain.from_iterable(list3)))
print(list(itertools.chain(*list3)))#unpacked in form of chain([1,2,3],[4,5,6])
